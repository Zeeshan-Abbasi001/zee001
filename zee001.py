...
------------------------------------------------""")
 ...
 [*] GitHub   : BLACK_WOLF_99
 [*] WhatsApp : +923162219719
 [*] Version  : 0.1
------------------------------------------------""")
...
if mlic in r:
    ...
    print('')
    input('\033[1;92m [√] Enter To sent key ')
    os.system('am start https://wa.me/+923162219719?text=Hi%20Bro,%20I%20Want%20To%20Buy%20Your%20Green-Lover%20Paid%20Tools.%20My%20Key:%20' + mlic) 
